...
export const EMAIL_TYPE_BADGE_COLORS = {
 ...
 [EMAIL_TYPES.OFFER_RECEIVED]: 'bg-status-success-bg text-slate-900',
 [EMAIL_TYPES.OFFER_COUNTER_RECEIVED]: 'bg-status-success-bg text-slate-900',
 [EMAIL_TYPES.OFFER_ACCEPTED]: 'bg-status-success-bg text-slate-900',
 ...
 [EMAIL_TYPES.PAYMENT_RECEIPT]: 'bg-slate-200 text-slate-900',
