...
const HeroSection = () => {
  ...
  return <section className="relative overflow-hidden bg-page-hero border-b border-slate-200/70">
        ...
        <div className="grid lg:grid-cols-[minmax(0,1fr)_520px] lg:items-center gap-8 lg:gap-10">
          <div className="max-w-2xl">
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3 max-w-2xl">
              <Link to={ROUTES.LISTINGS_PREFILTER} className="group flex min-w-0 flex-1 items-center gap-3 rounded-2xl bg-white px-4 py-3.5 text-sm font-semibold text-slate-500 border border-slate-200 shadow-[0_18px_45px_-28px_rgba(15,23,42,0.45)] hover:border-slate-300 transition-all">
