      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="max-w-2xl mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight leading-snug">
            Real product capabilities ensuring safe pazar yeri trades
          </h2>
          <p className="text-slate-500 text-sm mt-3 leading-relaxed font-medium">
            We prioritize real, working technology over marketing promises. Here are the core security modules actively powered by SecondHand.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TRUST_FEATURES.map((feat) => {
            ...
            return (
              <div
                key={feat.title}
                className="group border border-slate-100 rounded-2xl p-6 bg-slate-50/30 transition-all duration-200 hover:bg-white hover:border-slate-200/80 hover:shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col justify-between"
              >
                <div>
