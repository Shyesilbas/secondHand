...
const ShowcaseSection = () => {
  ...
  return <section className="py-12 sm:py-14 bg-[#f5f7fb] border-y border-border-light/60">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 mb-7">
          ...
          <Link to={ROUTES.LISTINGS} className="inline-flex w-fit items-center gap-2 px-5 py-3 bg-background-primary border border-border-light text-slate-700 rounded-xl font-bold text-sm hover:bg-slate-50 transition-all active:scale-95 shadow-sm">
        ...
        <div className="mb-6 overflow-x-auto scrollbar-hide">
          <div className="flex gap-1.5 p-1 bg-slate-200/50 rounded-2xl w-fit">
            ...
            return <button key={value} onClick={() => setActiveTab(value)} className={`
                    ...
                    ${active ? 'bg-background-primary text-text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'}
                  `}>
