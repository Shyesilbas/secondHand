      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="mb-5 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <p className="text-xs font-medium text-slate-500 max-w-sm">
            Jump into the most active marketplace lanes without scanning the whole catalog.
          </p>
        </div>
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className="flex flex-col items-center justify-center shrink-0 w-28 h-24 md:w-auto md:h-24 rounded-2xl border border-slate-100 bg-white p-3 transition-all duration-200 hover:border-slate-300 hover:shadow-[0_18px_40px_-30px_rgba(15,23,42,0.45)] group"
              >
