...
const SecurityActivityList = ({
  ...
  if (auditLogs.length === 0) {
    return <div className="bg-background-primary rounded-2xl border border-border-light shadow-sm p-12 text-center mb-10">
                <div className="w-16 h-16 mx-auto mb-4 bg-tertiary rounded-2xl flex items-center justify-center">
                ...
                <p className="text-text-secondary">{t("you_don_t_have_any_security_events_yet")}</p>
            </div>;
  }
  return <div className="bg-background-primary rounded-2xl border border-border-light shadow-sm overflow-hidden mb-10">
            ...
            <div className="divide-y divide-gray-200">
                {auditLogs.map((log, index) => <div key={log.id || index} className="p-6 hover:bg-secondary transition-colors cursor-pointer" onClick={() => setSelectedLog(log)}>
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-sm font-medium text-text-secondary">{getBrowserInfo(log.userAgent)}</span>
                                </div>
