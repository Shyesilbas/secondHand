  ...
  return <div className="min-h-screen bg-[#FAFAFA] text-[#1A1A1A]">
            ...
            <div className="max-w-6xl mx-auto px-6 py-12">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    <button onClick={() => setShowRevokeModal(true)} className="flex items-center justify-center gap-2 bg-white border border-red-100 text-red-600 px-5 py-3 rounded-xl font-semibold text-sm hover:bg-red-50 hover:border-red-200 transition-all shadow-sm active:scale-95">
                        <LogOut size={18} />{t("revoke_all_sessions")}</button>
                </div>

                {error && <div className="mb-8 p-4 bg-red-50 border border-red-100 rounded-2xl flex items-center gap-3 text-red-700">
