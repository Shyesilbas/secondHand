...
const OrderSuccessPage = () => {
 ...
 <div className="px-6 py-7 border-b border-slate-100 text-center bg-gradient-to-b from-indigo-50/90 to-white relative">
 <div className="relative inline-flex items-center justify-center mx-auto mb-4">
 <span className="absolute inline-flex h-20 w-20 rounded-full border-2 border-slate-400/50" style={{
 ...
 <div className="p-3 bg-slate-100 border border-primary rounded-xl text-xs text-primary leading-relaxed font-medium">
