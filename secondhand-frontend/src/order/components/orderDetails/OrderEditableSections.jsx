  ...
  if (isEditingAddress) {
    return <CardComponent className="p-5">
        ...
        {addressesLoading ? <p className="text-xs text-slate-500">{t("loading_addresses")}</p> : <div className="space-y-3.5">
            <div>
              <label className="text-[11px] font-semibold text-slate-500 mb-1.5 block">{t("shipping_address")}</label>
            ...
            <div>
              <label className="text-[11px] font-semibold text-slate-500 mb-1.5 block">{t("billing_address_optional")}</label>
  ...
  return <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <CardComponent className="p-4">
          ...
          <p className="text-[12px] text-slate-500 mt-1">{t("tr_vat")}{selectedOrder.orderNumber}</p>
        </CardComponent>
      </div>
