...
const StatusPill = ({ isExpired, remaining, t }) => {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 text-emerald-700 text-[10px] font-bold uppercase tracking-wider border border-emerald-100">
...
const MyShowcasesPanel = ({ userId }) => {
  ...
  return (
    <div className="bg-background-primary rounded-3xl border border-slate-200/60 p-6 lg:p-8 mt-8 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 mb-7">
        <div>
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-indigo-50 text-primary flex items-center justify-center border border-primary/10 shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-xl text-[11px] font-bold border border-emerald-100">
                  ...
                  <div className={`flex items-center gap-2 p-2 rounded-xl ${
                    ...
                    <button
                      ...
                      className={`h-10 px-5 rounded-xl text-xs font-bold transition-all duration-200 active:scale-95 disabled:opacity-50 tracking-wide uppercase flex items-center gap-1.5 shrink-0 ${
                        showcase.isExpired
                          ? 'bg-primary text-white hover:bg-primary-hover shadow-sm shadow-indigo-600/10'
      ...
      {/* ─── Info Banner ─── */}
      <div className="mt-7 p-4 rounded-2xl bg-indigo-50/50 border border-primary/20 flex items-start gap-3">
