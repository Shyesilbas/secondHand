      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[500px]">
        ...
        <div className="lg:col-span-5 bg-slate-50/80 p-6 sm:p-7 border-b lg:border-b-0 lg:border-r border-slate-200/80 flex flex-col justify-between">
          <div className="space-y-6">
            ...
            <div>
              <div className="w-11 h-11 rounded-2xl bg-emerald-600 flex items-center justify-center text-white shadow-md shadow-emerald-600/20 mb-3">
            ...
            {(listing || listingTitle) && (
              <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white border border-slate-200 shadow-xs">
                ...
                <div className="min-w-0 flex-1">
                  <span className="inline-flex items-center gap-1 text-[9px] font-extrabold text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded-full uppercase tracking-wider mb-0.5">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex justify-between text-xs text-slate-500 font-medium">
                ...
                <span className="font-extrabold text-slate-900 font-mono">{days} Gün</span>
              </div>
              {showcasePricing && (
                <>
                  <div className="flex justify-between text-xs text-slate-500 font-medium">
                    <span>Günlük Birim Ücret</span>
                    <span className="font-mono font-bold text-slate-800">₺{showcasePricing.dailyCost.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-xs text-slate-500 font-medium">
                  ...
                  <div className="flex justify-between text-xs text-slate-500 font-medium">
                    ...
                    <span className="font-mono font-bold text-slate-800">₺{calculateTax().toFixed(2)}</span>
                  </div>
                </>
              )}
            </div>
          ...
          <div className="pt-6 mt-6 border-t border-slate-200">
            <div className="flex items-baseline justify-between mb-3">
              ...
              <div className="text-right">
                <span className="text-2xl font-extrabold font-mono text-slate-950 tracking-tight">
                  ₺{totalCost.toFixed(2)}
                </span>
                <span className="text-[10px] font-bold text-emerald-700 block">KDV Dahil</span>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <label className="text-xs font-extrabold text-slate-900 uppercase tracking-wider flex items-center gap-2">
                  <Clock className="w-4 h-4 text-emerald-600" /> Vitrin Süresi
                </label>
                ...
                {PRESET_DURATIONS.map(opt => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-xs font-extrabold font-mono ${isSelected ? 'text-emerald-100' : 'text-slate-600'}`}>
              ...
              <div className="flex items-center justify-between gap-3 bg-slate-50 rounded-xl px-4 py-2.5 border border-slate-200">
                ...
                <div className="flex items-center gap-1.5 bg-white rounded-lg px-2.5 py-1 border border-slate-200 shadow-xs">
                  <input
                    ...
                    className="w-10 bg-transparent text-xs font-extrabold text-slate-900 focus:outline-none text-right font-mono"
                  />
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2.5">
                ...
                <button
                  ...
                  className="w-full sm:w-1/2 py-2.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-extrabold uppercase tracking-wider shadow-xs transition-all cursor-pointer flex items-center justify-center gap-1.5 active:scale-[0.98]"
                >
