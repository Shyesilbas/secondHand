...
const CompareModal = memo(() => {
  ...
  return <div className="fixed inset-0 z-[100] overflow-hidden">
            ...
            <div className="absolute inset-3 sm:inset-6 lg:inset-10 flex items-center justify-center p-2">
                <div role="dialog" aria-modal="true" className="relative w-full max-w-7xl max-h-[min(92vh,900px)] bg-white rounded-2xl shadow-2xl shadow-slate-900/20 flex flex-col overflow-hidden border border-slate-200/90 ring-1 ring-slate-900/5">
                    <div className="flex-shrink-0 px-5 py-4 border-b border-slate-100 bg-gradient-to-r from-indigo-50/80 via-white to-white">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <button type="button" onClick={closeModal} className="p-2 text-slate-500 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-colors shrink-0" aria-label={t("close")}>
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 overflow-auto min-h-0">
                        <table className="w-full border-collapse text-sm">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {fields.map(field => <tr key={field.key} className="bg-white even:bg-slate-50/40">
                  ...
                  return <td key={item.id} className={`
                    ...
                    <div className="flex-shrink-0 px-5 py-3 border-t border-slate-100 bg-slate-50/80">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <button type="button" onClick={closeModal} className="self-end sm:self-auto px-4 py-2 text-sm font-medium text-slate-700 hover:text-slate-900 bg-white border border-slate-200 hover:bg-slate-50 rounded-xl transition-colors">{t("close")}</button>
                        </div>
                    </div>
                </div>
            </div>
