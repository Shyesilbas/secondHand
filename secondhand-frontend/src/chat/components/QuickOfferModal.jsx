                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <h3 className="font-extrabold text-slate-900 dark:text-white text-base">
                                {t('quick_offer_title', 'Sohbet İçi Teklif Yap')}
                            </h3>
                            <p className="text-xs text-slate-500 dark:text-slate-400">
                                {t('quick_offer_subtitle', 'Alıcı veya satıcıya doğrudan teklif tutarını iletin')}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                            {t('offered_price', 'Teklif Edeceğiniz Tutar (₺)')}
                        </label>
                    ...
                    <div className="flex items-center gap-3 pt-2">
                        ...
                        >
                            ...
                            {isPending ? t('sending', 'Gönderiliyor...') : t('send_offer', 'Teklifi Gönder')}
                        </button>
                    </div>
                </form>
            </div>
