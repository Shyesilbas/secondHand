                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2.5">
                        <h3 className="text-base font-bold text-slate-900 tracking-tight">{t("premium_membership_active")}</h3>
                      ...
                      <p className="text-xs text-slate-500 mt-1 font-medium">{t("enjoy_premium_perks")}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-3.5 rounded-xl bg-slate-50/50 border border-slate-100">
                      <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1">{t("fast_shipping")}</div>
                      <span className="text-xs font-bold text-emerald-600">{estimatedShippingDays} {t("days_priority")}</span>
                    </div>
                    <div className="p-3.5 rounded-xl bg-slate-50/50 border border-slate-100">
                      <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1">{t("shipping_process")}</div>
                      <span className="text-xs font-bold text-emerald-600">{orderProcessingSpeed}</span>
                    </div>
                    <div className="p-3.5 rounded-xl bg-slate-50/50 border border-slate-100">
                      <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1">{t("aura_ai_message_limit")}</div>
                      <span className="text-xs font-bold text-slate-900">{t('daily_x_messages', 'Günlük {{count}} Mesaj', { count: dailyAuraLimit })}</span>
                    </div>
                    <div className="p-3.5 rounded-xl bg-slate-50/50 border border-slate-100">
                      <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-1">{t("showcase_slot")}</div>
                      <span className="text-xs font-bold text-slate-900">{activeShowcasesCount} / {maxShowcaseSlots} {t("slots_active")}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 border border-slate-200/60 p-5 rounded-3xl md:min-w-[240px] flex flex-col justify-between items-stretch z-10 shadow-sm">
                  ...
                  <div className="space-y-3">
                    {purchaseDate && (
                      <div className="flex flex-col items-start text-left">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t("start_date")}</span>
                    ...
                    {expirationDate && (
                      <div className="flex flex-col items-start text-left border-t border-slate-100 pt-2.5">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t("end_date")}</span>
                    ...
                    <div className="border-t border-slate-100 pt-2.5 flex flex-col items-start text-left">
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t("auto_renew")}</span>
                      <span className={`text-xs font-bold mt-0.5 ${autoRenew ? 'text-emerald-600' : 'text-slate-500'}`}>
                        {autoRenew ? t("enabled_default") : t("disabled")}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 pt-3 border-t border-slate-250">
                    {autoRenew ? (
                      ...
                      >
                        {isCancelling ? t("processing_progress") : t("cancel_subscription")}
                      </button>
                    ) : (
                      <div className="space-y-2">
                        ...
                        >
                          {isTogglingAutoRenew ? t("enabling") : t("reactivate")}
                        </button>
                      </div>
                    )}
                  </div>
