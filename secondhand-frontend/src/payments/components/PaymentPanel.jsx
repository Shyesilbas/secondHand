        ...
        {selectedListing ? (
          <div className="space-y-3.5">
            ...
            <button
              ...
              className="w-full rounded-xl bg-emerald-600 hover:bg-emerald-700 px-4 py-3 text-xs font-bold text-white shadow-md shadow-emerald-600/20 transition-all hover:shadow-lg active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-emerald-600 flex items-center justify-center gap-2"
            >
              {isProcessingPayment ? (
                <>
