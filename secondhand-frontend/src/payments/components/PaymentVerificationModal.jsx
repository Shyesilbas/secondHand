            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {otpTtlActive ? (
                    <div
                      className={`text-xs font-medium tabular-nums ${otpTtlExpired ? 'text-amber-700' : 'text-slate-600'}`}
                    >
                      {otpTtlExpired ? 'Code expired — resend required' : (
                        <>
                          Expires in: <span>{otpTtlFormatted}</span>
                        </>
                      )}
                    </div>
                  ) : null}
        ...
        <div className="flex items-center gap-3 border-t border-slate-100 bg-slate-50/80 px-6 py-4">
          ...
          {step === VERIFICATION_STEPS.REVIEW ? (
            ...
            <button
              ...
              disabled={
                isProcessing
                || (verificationCode || '').length !== OTP_CODE_LENGTH
                || otpTtlExpired
              }
