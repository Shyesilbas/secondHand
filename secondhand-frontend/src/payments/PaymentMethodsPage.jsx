        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {isLoading && (
                <div className="animate-pulse space-y-6">
                    ...
                    <div className={`grid grid-cols-1 ${activeTab === 'credit-cards' ? 'md:grid-cols-2 lg:grid-cols-3' : 'md:grid-cols-2'} gap-6`}>
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button
                                    onClick={() => {
                                        notification.showConfirmation(
                                            'Create Credit Card',
                                            'Are you sure you want to create a new credit card?',
