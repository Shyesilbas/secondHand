...
const ListingsPage = () => {
  ...
  return <ListingsModuleLayout mode="browse" engine={engine} getListingTypeLabel={getListingTypeLabel} onListingChanged={handleListingChanged} title={t("browse_listings")} />;
};
