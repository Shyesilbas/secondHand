  ...
  return (
    <div className="bg-slate-50 border border-slate-200/80 rounded-3xl p-5 sm:p-6 mb-4 shadow-xs">
      ...
      <p className="text-xs leading-relaxed text-slate-600 font-medium mb-6">
        ...
        <strong className="text-emerald-700 font-extrabold">{t("safe_meetup_guarantee", "Güvenli Buluşma Garantisi")}</strong>
      ...
      <div className="space-y-4 relative before:absolute before:left-[17px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-200">
        <div className="relative flex gap-3.5 items-start z-10">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-white border border-slate-200 text-emerald-700 shadow-xs font-mono font-extrabold text-xs">
            1
          </div>
        ...
        <div className="relative flex gap-3.5 items-start z-10">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-white border border-slate-200 text-amber-600 shadow-xs font-mono font-extrabold text-xs">
            2
          </div>
          <div className="pt-0.5">
        ...
        <div className="relative flex gap-3.5 items-start z-10">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-white border border-slate-200 text-blue-600 shadow-xs font-mono font-extrabold text-xs">
            3
          </div>
          <div className="pt-0.5">
