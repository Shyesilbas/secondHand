    ...
    if (isLoading) {
        return (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {[...Array(8)].map((_, index) => (
                    <div key={index} className="bg-background-primary rounded-xl shadow-sm border border-border-light overflow-hidden animate-pulse">
                        ...
                        <div className="p-4">
                            ...
                            <div className="w-3/4 h-5 bg-secondary-200 rounded mb-2"></div>
                            <div className="w-full h-4 bg-secondary-200 rounded mb-3"></div>
                            <div className="w-1/2 h-6 bg-secondary-200 rounded mb-3"></div>
