...
export const AuraSummary = ({
  ...
  return <div className="rounded-2xl border border-primary/80 bg-indigo-50/20 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-3 mb-3 flex-wrap">
                ...
                <span className="text-[9px] font-bold text-primary uppercase bg-indigo-50 px-2.5 py-0.5 rounded-full border border-primary shadow-sm shrink-0">{t("analizler_belirli_aral_klarla_tekrar_yap")}</span>
            </div>

            {loading ? <div className="flex items-center text-xs text-primary font-semibold py-2">
                    ...
                    {error}
                </div> : <p className="text-xs sm:text-sm text-primary/80 leading-relaxed font-semibold whitespace-pre-line">
                    {summary}
                </p>}
        </div>;
};
