                            ...
                            <>
                                <div className="flex items-center gap-1 mr-2">
                                    ...
                                    <div className="relative" ref={paymentsMenuRef}>
                                        <button
                                            onClick={() => dropdowns.toggle('payments')}
                                            title="Payments"
                                            type="button"
                                            className="group relative p-2.5 text-slate-600 hover:text-slate-900 transition-all duration-300 ease-in-out rounded-xl hover:bg-slate-100/50"
                                        >
                                        ...
                                        {paymentsMenuOpen && (
                                            <div className="absolute top-full right-0 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/50 p-2 z-50">
                                                <Link to={ROUTES.PAYMENTS} onClick={dropdowns.closeAll} className="flex items-center gap-3 px-4 py-3 hover:bg-slate-50/80 transition-all duration-300 ease-in-out rounded-xl">
                                                    <Receipt className="w-4 h-4 text-slate-600" />
                                                    <span className="text-sm font-medium text-slate-900">Payments</span>
                                                </Link>
                                                <Link to={ROUTES.PAYMENT_METHODS} onClick={dropdowns.closeAll} className="flex items-center gap-3 px-4 py-3 hover:bg-slate-50/80 transition-all duration-300 ease-in-out rounded-xl">
                                                    <CreditCard className="w-4 h-4 text-slate-600" />
                                                    <span className="text-sm font-medium text-slate-900">Payment Methods</span>
                                                </Link>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="relative" ref={listingsMenuRef}>
                                        <button
                                            onClick={() => dropdowns.toggle('listings')}
                                            className="group relative p-2.5 text-slate-600 hover:text-slate-900 transition-all duration-300 ease-in-out rounded-xl hover:bg-slate-100/50"
                                        >
                                        ...
                                        {listingsMenuOpen && (
                                            <div className="absolute top-full right-0 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/50 p-2 z-50">
                                                ...
                                                <Link to={ROUTES.MY_LISTINGS} onClick={dropdowns.closeAll} className="flex items-center gap-3 px-4 py-3 hover:bg-slate-50/80 transition-all duration-300 ease-in-out rounded-xl">
                                ...
                                <div className="relative" ref={profileMenuRef}>
                                    <button
                                        onClick={() => dropdowns.toggle('profile')}
                                    ...
                                    {profileMenuOpen && (
                                        <div className="absolute top-full right-0 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/50 p-2 z-[9999]">
                                            ...
                                            >
                                                <Settings className="w-4 h-4 mr-3" /> Account Hub
                                            </Link>
                                            <Link
                                                to={ROUTES.AURA_CHAT}
                                            onClick={dropdowns.closeAll}
