...
const SearchResults = ({
    ...
    return <div className="py-1">
        ...
        return <div key={link.id} onClick={() => onResultSelect({
          ...
          type: 'link'
              ...
              <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-colors ${isSelected ? 'bg-white/15 text-white' : 'bg-slate-100 text-slate-500'}`}>
  ...
  const renderUserResult = (user, index) => <div key={user.id} onClick={() => onResultSelect(user)} className={`px-4 py-3 cursor-pointer border-b border-gray-100 last:border-b-0 hover:bg-gray-50 ${index === selectedIndex ? 'bg-blue-50' : ''}`}>
  ...
  const renderListingResult = (listing, index) => <div key={listing.id} onClick={() => onResultSelect(listing)} className={`px-4 py-3 cursor-pointer border-b border-gray-100 last:border-b-0 hover:bg-gray-50 ${index === selectedIndex ? 'bg-blue-50' : ''}`}>
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {listing.price && <div className="text-sm font-semibold text-blue-600 mt-1">
