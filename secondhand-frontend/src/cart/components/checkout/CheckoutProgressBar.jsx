...
const CheckoutProgressBar = ({
 ...
 isCurrent
 ? 'bg-white shadow-xs border border-slate-200/90 text-slate-900 font-bold'
 : isCompleted
 ...
 : isCurrent
 ? 'bg-slate-200/90 text-slate-900 border border-slate-400'
 ...
 <span className={`h-1 w-3 rounded-full transition-colors ${isCompleted ? 'bg-slate-800/40' : 'bg-slate-300'}`} />
 </div>
 )}
 </React.Fragment>
 );
