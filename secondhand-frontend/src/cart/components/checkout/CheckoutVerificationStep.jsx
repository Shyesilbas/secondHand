    ...
    <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-6 sm:p-8">
      ...
      <div className="mx-auto max-w-md">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-4 text-xs font-extrabold uppercase tracking-wider text-white transition-all hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-400 shadow-xs active:scale-[0.98]"
        >
          {isCheckingOut ? (
            <>
