      ...
      <div className="flex gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            ...
            <button type="button" onClick={handleRemove} disabled={isRemoving} className="shrink-0 rounded-xl p-1.5 text-text-muted transition hover:bg-[#eef4fb] hover:text-[#1466c6] disabled:opacity-40" title={t("remove")}>
