...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByUserWithOrderItems(@Param("user") User user);
        ...
        @Query("SELECT SUM(o.totalAmount) FROM Order o WHERE o.user = :user AND o.createdAt BETWEEN :startDate AND :endDate AND o.paymentStatus != 'FAILED' AND o.status != 'CANCELLED' AND o.status != 'REFUNDED'")
