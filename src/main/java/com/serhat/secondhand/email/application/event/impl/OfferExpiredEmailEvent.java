...
public class OfferExpiredEmailEvent extends EmailEvent<OfferEmailData> {
    public OfferExpiredEmailEvent(User recipient, String subject, OfferEmailData data) {
        super(recipient, subject, EmailType.OFFER_EXPIRED, EmailPriority.NORMAL, data);
    }

    @Override
    public String getTemplatePath() {
        return "offers/expired.html";
    }
}
