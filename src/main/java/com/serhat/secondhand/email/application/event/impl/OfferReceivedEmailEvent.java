...
public class OfferReceivedEmailEvent extends EmailEvent<OfferEmailData> {
    public OfferReceivedEmailEvent(User recipient, String subject, OfferEmailData data) {
        super(recipient, subject, EmailType.OFFER_RECEIVED, EmailPriority.HIGH, data);
    }

    @Override
    public String getTemplatePath() {
        return "offers/received.html";
    }
}
