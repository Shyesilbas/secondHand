...
public enum PaymentErrorCodes implements ErrorCode {
    ...
    INVALID_CARD_NUMBER("INVALID_CARD_NUMBER", "Card number is invalid", HttpStatus.BAD_REQUEST),
    INVALID_CVV("INVALID_CVV", "CVV must be 3 or 4 digits", HttpStatus.BAD_REQUEST),
    INVALID_EXPIRY("INVALID_EXPIRY", "Expiry month must be between 1 and 12", HttpStatus.BAD_REQUEST),
    CARD_EXPIRED("CARD_EXPIRED", "The card has already expired", HttpStatus.BAD_REQUEST),
